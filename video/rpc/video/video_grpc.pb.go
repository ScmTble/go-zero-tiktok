...
func (c *videoClient) PublishVideoList(ctx context.Context, in *PublishVideoListReq, opts ...grpc.CallOption) (*PublishVideoListResp, error) {
	out := new(PublishVideoListResp)
...
type VideoServer interface {
	...
	PublishVideoList(context.Context, *PublishVideoListReq) (*PublishVideoListResp, error)
...
func (UnimplementedVideoServer) PublishVideoList(context.Context, *PublishVideoListReq) (*PublishVideoListResp, error) {
...
func _Video_PublishVideoList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VideoServer).PublishVideoList(ctx, req.(*PublishVideoListReq))
	}
	return interceptor(ctx, in, info, handler)
}
